          ...
          <div style={{ width: "100%", maxWidth: 360 }}>
            ...
            <div className="login-mobile-brand">
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                <EverionLogo size={22} />
                <span style={{ fontFamily: "var(--f-sans)", fontWeight: 700, fontSize: 20, color: "var(--color-on-surface)", letterSpacing: "-0.02em" }}>Everion</span>
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                >
                  <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
                    <path fill="#EA4335" d="M24 9.5c3.5 0 6.6 1.2 9.1 3.2l6.8-6.8C35.8 2.3 30.2 0 24 0 14.8 0 6.9 5.4 3 13.3l7.9 6.1C12.8 13.2 17.9 9.5 24 9.5z"/>
