...
export const FEATURE_FLAGS = {
  ...
  graph:    { label: "Knowledge Graph",   icon: "✦",  prodEnabled: import.meta.env.VITE_FEATURE_GRAPH    === "true" },
  todos:    { label: "Todos",             icon: "✓",  prodEnabled: import.meta.env.VITE_FEATURE_TODOS    === "true" },
  timeline: { label: "Timeline",          icon: "◷",  prodEnabled: import.meta.env.VITE_FEATURE_TIMELINE === "true" },
...
export function isFeatureEnabled(key: FeatureFlagKey, adminFlags: Record<string, boolean>): boolean {
