...
export const SUGGESTIONS: Suggestion[] = (
  [
    ...
    {
      q: "Do you have a copy of your ID stored digitally in a safe place?",
      cat: "📄 Documents",
      p: "medium",
    },
    ...
    {
      q: "Mental health support — therapist, counsellor, or psychologist contact?",
      cat: "🏥 Health",
      p: "medium",
    },
    ...
    {
      q: "Extended family — grandparents, aunts, uncles who are important contacts?",
      cat: "👨‍👩‍👧 Family",
      p: "low",
    },
    ...
    {
      q: "Do you have a retirement annuity (RA)? Provider and value?",
      cat: "💰 Finance",
      p: "medium",
    },
    ...
    {
      q: "Home contents insurance — provider, policy, and value covered?",
      cat: "📋 Insurance",
      p: "high",
    },
    { q: "Home contents insurance excess?", cat: "📋 Insurance", p: "medium" },
    {
      q: "Public liability insurance — provider and policy number?",
      cat: "📋 Insurance",
      p: "medium",
    },
    ...
    {
      q: "If renting — monthly rent, lease end date, landlord contact?",
      cat: "🏠 Home",
      p: "high",
    },
    ...
    {
      q: "Any appliances under warranty — make, serial number, expiry?",
      cat: "🏠 Home",
      p: "medium",
    },
    ...
    {
      q: "Finance details — bank, monthly payment, balloon/end date?",
      cat: "🚗 Vehicle",
      p: "high",
    },
    ...
    {
      q: "Key contractors you use regularly — names and what they do?",
      cat: "👷 Contractors",
      p: "medium",
    },
    {
      q: "Anyone who's offered to help with something — capture it before you forget?",
      cat: "📇 Contacts",
      p: "medium",
    },
    ...
    {
      q: "Important account recovery backup emails or phone numbers?",
      cat: "🔑 Security",
      p: "high",
    },
    ...
    {
      q: "Do you have a retirement plan? At what age do you want to retire?",
      cat: "🎯 Goals",
      p: "medium",
    },
    ...
    {
      q: "Streaming subscriptions — which ones and monthly cost?",
      cat: "💳 Subscriptions",
      p: "low",
    },
    ...
    {
      q: "Productivity suite — Microsoft 365 or Google Workspace?",
      cat: "💳 Subscriptions",
      p: "medium",
    },
    ...
    {
      q: "Cloud storage subscriptions — iCloud, Google Drive, Dropbox?",
      cat: "💳 Subscriptions",
      p: "low",
    },
    ...
    // ─── DAILY LIFE ───
    {
      q: "Morning routine — what does a typical morning look like?",
      cat: "☀️ Daily Life",
      p: "low",
    },
    ...
    {
      q: "Passport expiry date — is it valid for everywhere you want to go?",
      cat: "✈️ Travel",
      p: "high",
    },
    ...
    // ─── REFLECTIONS ───
    {
      q: "What have been your biggest lessons in life or work so far?",
      cat: "💡 Reflection",
      p: "low",
    },
    ...
    {
      q: "What recurring problem do you want to permanently fix this year?",
      cat: "💡 Reflection",
      p: "medium",
    },
    {
      q: "What are you avoiding that you know you should address?",
      cat: "💡 Reflection",
      p: "medium",
    },
    {
      q: "If money wasn't an issue, what would you spend your time on?",
      cat: "💡 Ideas",
      p: "low",
    },
    ...
    {
      q: "When does your medical aid annual premium increase take effect?",
      cat: "📅 Dates",
      p: "medium",
    },
    {
      q: "Lease renewal negotiation start date (6 months before expiry)?",
      cat: "📅 Dates",
      p: "high",
    },
    ...
    // ─── EMERGENCY NUMBERS ───
    {
      q: "Emergency services numbers saved — police, ambulance, fire?",
      cat: "📞 Numbers",
      p: "high",
    },
    ...
    {
      q: "Do you have a generator or inverter at home? Specs and battery runtime?",
      cat: "🏠 Home",
      p: "medium",
    },
    ...
    {
      q: "Academic certificates or qualifications — where are they stored?",
      cat: "📄 Documents",
      p: "medium",
    },
    ...
    {
      q: "Vaccination history — Covid, flu, travel vaccines worth noting?",
      cat: "🏥 Health",
      p: "low",
    },
    ...
    {
      q: "Social media handles — which platforms and what's the username?",
      cat: "📣 Marketing",
      p: "medium",
    },
