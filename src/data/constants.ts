...
export const PC: Record<Priority, PriorityConfig> = { high: { bg: "#FF6B3520", c: "#FF6B35", l: "High" }, medium: { bg: "#FFEAA720", c: "#FFEAA7", l: "Med" }, low: { bg: "#4ECDC420", c: "#4ECDC4", l: "Low" } };
export const fmtD = (d: string | Date): string => new Date(d).toLocaleDateString("en-ZA", { day: "numeric", month: "short", year: "numeric" });
