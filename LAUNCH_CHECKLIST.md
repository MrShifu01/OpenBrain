...
| **Maintainability**    | 7.5 / 10 | TypeScript strict, 11 e2e specs, 45+ unit tests, Vitest + Playwright separated cleanly, CLAUDE.md + RUNBOOK.md present. ESLint warning ratchet at 212 (down from 297). Drag: 6 `as any` casts in src/ (all legit ESM-compat or annotated Supabase quirks), three god-components >1000 lines (TodoCalendarTab, VaultView, EntryList).                                                                  |
