...
| **UI / Visual** | 7.5 / 10 | Strong design language (Espresso/Ivory/Bronze + serif/sans pairing), WCAG AA dark-theme contrast bump shipped, mobile + desktop layouts diverge cleanly. No tablet hack. Settings sidebar is dense (14 tabs). |
...
- [ ] **Settings consolidation experiment** — A/B the 14-tab vs collapsed-5-group structure with PostHog after launch.
