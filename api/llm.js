...
async function handleAnthropic(req, res, { model, messages, max_tokens, system, apiKey }) {
...
async function handleOpenAI(req, res, { model, messages, max_tokens, system, apiKey }) {
...
async function handleOpenRouter(req, res, { model, messages, max_tokens, system, apiKey }) {
