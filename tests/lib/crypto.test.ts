...
import {
  ...
  generateSalt, deriveKeyFromPassphrase,
  setupVault, unlockVault,
  generateRecoveryKey,
  encryptVaultKeyForRecovery, decryptVaultKeyFromRecovery,
...
describe('crypto', () => {
  ...
  it('encryptEntry and decryptEntry roundtrip', async () => {
    ...
    const entry = { id: '1', title: 'Secret', content: 'hidden text', type: 'secret' as const, metadata: { phone: '123' } };
